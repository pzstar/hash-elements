...
if (!function_exists('hash_elements_author_name')) {
    ...
    function hash_elements_author_name() {
        echo '<span class="he-post-author"><i class="fa fa-pencil"></i>' . get_the_author() . '</span>';
    }
...
if (!function_exists('hash_elements_comment_count')) {
    ...
    function hash_elements_comment_count() {
        echo '<span class="he-post-comment"><i class="fa fa-comment-o"></i>' . get_comments_number() . '</span>';
    }
...
if (!function_exists('hash_elements_post_date')) {
    ...
    function hash_elements_post_date($format = '') {
        ...
        if ($format) {
            echo '<span class="he-post-date"><i class="fa fa-clock-o"></i>' . get_the_date($format) . '</span>';
        } else {
            echo '<span class="he-post-date"><i class="fa fa-clock-o"></i>' . get_the_date() . '</span>';
        }
    }
...
if (!function_exists('hash_elements_time_ago')) {
    ...
    function hash_elements_time_ago() {
        echo '<span class="he-post-date"><i class="fa fa-clock-o"></i>' . human_time_diff(get_the_time('U'), current_time('timestamp')) . ' ' . __('ago', 'hash-elements') . '</span>';
    }
