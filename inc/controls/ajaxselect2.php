...
class HashElements_Ajax_Select2 extends Base_Data_Control {
    ...
    public function enqueue() {
        wp_enqueue_script('ajaxselect2-editor', HASHELE_ASSETS_URL . 'js/ajaxselect2-editor.js');
    }
