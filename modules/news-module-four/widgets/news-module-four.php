...
class NewsModuleFour extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .he-news-module-four .he-block-title a, 
                 {{WRAPPER}} .he-news-module-four .he-block-title' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .he-news-module-four .he-block-title a span:before, 
                 {{WRAPPER}} .he-news-module-four .he-block-title span:before' => 'background: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'selector' => '{{WRAPPER}} .he-news-module-four .he-block-title a, 
                           {{WRAPPER}} .he-news-module-four .he-block-title',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .he-news-module-four .he-post-item:nth-child(1)' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
                '{{WRAPPER}} .he-news-module-four .he-post-item:nth-child(2)' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'hash-elements'),
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .he-news-module-four .he-post-item .he-post-title',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .he-news-module-four .he-post-item:nth-child(2), 
                             {{WRAPPER}} .he-news-module-four .he-post-item:nth-child(3)' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
