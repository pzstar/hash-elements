...
class NewsModuleEight extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .he-news-module-eight .he-block-title a, 
                 {{WRAPPER}} .he-news-module-eight .he-block-title' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .he-news-module-eight .he-block-title a span:before, 
                 {{WRAPPER}} .he-news-module-eight .he-block-title span:before' => 'background: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'selector' => '{{WRAPPER}} .he-news-module-eight .he-block-title a, 
                           {{WRAPPER}} .he-news-module-eight .he-block-title',
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'hash-elements'),
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .he-news-module-eight ul.post-categories li a,
                           {{WRAPPER}} .he-news-module-eight .post-content ul.post-categories li a',
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .he-news-module-eight ul.post-categories li  a' => 'background-color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .he-news-module-eight ul.post-categories li  a' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .he-news-module-eight ul.post-categories li:hover a' => 'background-color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .he-news-module-eight ul.post-categories li:hover a' => 'color: {{VALUE}}',
            ],
                ]
        );
